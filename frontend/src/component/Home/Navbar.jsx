...
const Navbar = () => {
    ...
    return (
        <div className={`max-w-full container mx-auto md:px-5 z-20
            ${sticky ? "sticky top-0 shadow-md bg-base-200 duration-300 translate-all ease-in-out dark:bg-slate-800" : ""}`}>
            <div className="navbar">
                ...
                <div className="navbar-end space-x-4">
                    ...
                    <div className="hidden md:block bg-white rounded-lg">
                        <label className="px-3 py-1 flex items-center gap-2 border rounded-lg">
                            <input type="text" className="grow outline-none border-none" placeholder="Search" />
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="h-4 w-4 opacity-70 cursor-pointer text-black">
